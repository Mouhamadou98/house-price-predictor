...
from prometheus_fastapi_instrumentator import Instrumentator # Pour les métriques Prometheus afin de surveiller les performances de l'API
...
# Initialize and Instrument the app for Prometheus metrics
Instrumentator().instrument(app).expose(
    app,
    endpoint="/metrics",          # explicite
